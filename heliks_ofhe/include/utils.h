...
vector<vector<int64_t>> gen2D_UID_int64(int dim0, int dim1, int min = 0, int max = 8);
...
void print1D(vector<int64_t> inp1D, int num_digits = 3, int max_row = 0);
...
void print2D(vector<vector<int64_t>> inp2D, int num_digits = 3, int max_row = 0, int max_col = 0);
...
void print3D(vector<vector<vector<int64_t>>> inp3D, int num_digits = 3, int max_row = 0);
...
vector<int64_t> slice1D(vector<int64_t>& arr, int X, int Y);
...
int64_t float_to_fixed(double flt_val, double scale = 1);
double fixed_to_float(int64_t flt_val, double scale = 1);
